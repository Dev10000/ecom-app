...
const News: React.FC = (): JSX.Element => {
    return (
        <div>
            <hr className="w-5/6 m-auto -mt-6 mb-16 border-3 border-gray-300" />
            <div className="flex flex-cols-3 gap-4 max-w-full mb-16">
                <div className="flex mx-auto px-4 sm:max-w-md mx-auto rounded-xl rounded-yl shadow-md overflow-hidden">
                    <div className="md:flex">
                        <div className="flex-1 md:flex-shrink-0">
                            <img
                                className="mt-8 mb-7 h-auto w-full object-cover border-r-2 md:w-48 h-auto"
                                src={Img1}
                                alt="img"
                            />
                        </div>
                ...
                <div className="flex mx-auto px-4 sm:max-w-md mx-auto rounded-xl rounded-yl shadow-md overflow-hidden">
                    <div className="md:flex">
                        <div className="flex-1 md:flex-shrink-0">
                            <img
                                className="h-auto w-full object-cover border-r-2 md:w-48 h-auto"
                                src={Img2}
                                alt="img"
                            />
                        </div>
                ...
                <div className="flex mx-auto px-4 sm:max-w-md mx-auto rounded-xl rounded-yl shadow-md overflow-hidden">
                    <div className="md:flex">
                        <div className="flex-1 md:flex-shrink-0">
                            <img
                                className="mt-4 mb-4 h-auto w-full object-cover border-r-2 md:w-48 h-auto"
                                src={Img3}
                                alt="img"
                            />
                        </div>
