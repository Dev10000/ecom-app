...
const Delete: React.FC<IDeleteConfirmationProps> = ({ forDeletion, setForDeletion, setUpdated }): JSX.Element => {
    ...
    return (
        <Modal
            ...
            className={`items-center align-bottom inline-block h-auto w-full max-w-xl m-auto relative top-2 left-2 right-2 bottom-2 bg-white dark:bg-gray-900 dark:text-white \
            bg-opacity-100 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all focus:outline-none`}
            isOpen={isOpen}
        ...
        >
            <div className="sm:flex sm:items-end md:flex-col">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left md:w-full">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Delete Article?</h3>
                    <div className="mt-2">
                        <p className="text-sm py-2 text-gray-500">
                            Are you sure you want to delete selected article? <br />
                ...
                <div className="mt-5 sm:mt-4 sm:ml-10 sm:pl-4 sm:flex">
                    <button
                        ...
                        text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:w-auto sm:text-sm ${
                    ...
                    <button
                        ...
                        text-base font-medium text-gray-700 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm ${
                            loading ? 'cursor-not-allowed' : ''
                        }`}
                        onClick={closeModal}
                        disabled={loading}
