            ...
            {!cartItems.length ? (
                <div className="w-full my-6">
                    ...
                    >
                        ...
                        <ellipse cx="354.13" cy="741.27" rx="176.1" ry="33.36" fill="#40bfff" opacity=".1" />
                        <path
                        ...
                        <path fill="#dce6f2" d="M317.24 201l15.25 18.34-1.99 18.51L312.07 209l5.17-8z" />
                        <path
                            opacity=".1"
                        ...
                        <path
                            ...
                            fill="#efb7b9"
                        />
                        <path d="M364.03 147.55s9.12 16.5 21.37 14.25 7.21-8.86 7.21-8.86z" fill="#444053" />
                        <path
                        ...
                        <path
                            ...
                            opacity=".1"
                        />
                        <path fill="#40bfff" d="M330.96 347.33l77-12.53v72.9l-73.16-3.83-3.84-56.54z" />
                        <path opacity=".05" d="M330.96 347.33l77-12.53v72.9l-73.16-3.83-3.84-56.54z" />
                        <path fill="#40bfff" d="M407.96 334.8l92.34 6.91-5.11 63.44-87.23 2.55v-72.9z" />
                        <path opacity=".1" d="M407.96 334.8l92.34 6.91-5.11 63.44-87.23 2.55v-72.9z" />
                        <path
                            fill="#40bfff"
                        ...
                        <path
                            ...
                            d="M500.3 341.71v97.2l-28.91 5.55-14.06 2.7-32.49 6.24v-99.67l75.46-12.02z"
                        />
                        <path fill="#40bfff" d="M303.08 368.31l27.88-20.98 93.88 6.4-13.82 23.28-107.94-8.7z" />
                        <path
                            fill="#fff"
                            opacity=".1"
                            d="M303.08 368.31l27.88-20.98 93.88 6.4-13.82 23.28-107.94-8.7z"
                        />
                        <path fill="#40bfff" d="M500.3 341.71l-75.46 12.02 24.56 22 80.83-13.56-29.93-20.46z" />
                        <path
                            fill="#fff"
                            opacity=".1"
                        ...
                        <path
                            ...
                            fill="#40bfff"
                        />
                        <ellipse cx="698.97" cy="716.3" rx="26.93" ry="4.55" fill="#40bfff" opacity=".1" />
                        <ellipse cx="600.8" cy="785.38" rx="26.93" ry="4.55" fill="#40bfff" opacity=".1" />
                        <ellipse cx="93.14" cy="749.99" rx="26.93" ry="4.55" fill="#40bfff" opacity=".1" />
                        <ellipse cx="805.06" cy="780.83" rx="26.93" ry="4.55" fill="#40bfff" opacity=".1" />
                        <ellipse cx="833.1" cy="723.1" rx="40.21" ry="6.8" fill="#40bfff" />
                        <path
                ...
                <>
                    <table className="w-full mt-8" cellSpacing={0} cellPadding={0}>
                        <thead>
                            <tr className="uppercase text-gray-700 border-b border-gray-200 p-4 mx-10 text-base font-medium">
                                <th>&nbsp;</th>
                                <th>Product</th>
                                <th>QTY</th>
                                <th>Unit Price</th>
